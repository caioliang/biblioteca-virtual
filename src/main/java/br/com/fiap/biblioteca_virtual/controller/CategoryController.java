package br.com.fiap.biblioteca_virtual.controller;
...
import br.com.fiap.biblioteca_virtual.repository.CategoryRepository;
...
public class CategoryController {
    ...
    public Category create(@RequestBody Category category) {
        log.info("Cadastrando categoria " + category.getTitulo());
